  ...
  Groups.get = function(groupName, options, callback) {
    ...
    async.parallel({
      ...
      plugins.fireHook('filter:parse.raw', results.base.description, function(err, descriptionParsed) {
        ...
        results.base.userTitleEnabled = results.base.userTitleEnabled ? Boolean(parseInt(results.base.userTitleEnabled, 10)) : true;
        ...
        results.base.deleted = Boolean(parseInt(results.base.deleted, 10));
        results.base.hidden = Boolean(parseInt(results.base.hidden, 10));
        results.base.system = Boolean(parseInt(results.base.system, 10));
        results.base.memberCount = parseInt(results.base.memberCount, 10);
        results.base.private = results.base.private === null || results.base.private === undefined ? true : Boolean(parseInt(results.base.private, 10));
    ...
    db.getObjects(keys, function(err, groupData) {
      ...
      groupData.forEach(function(group) {
        if (group) {
          ...
          group.private = group.private === null || group.private === undefined ? true : Boolean(parseInt(group.private, 10));
