<div class="mb-3">
	<label class="form-label" for="invite-modal-emails">{{tx("users:prompt-email")}}</label>
	<input id="invite-modal-emails" type="text" class="form-control" placeholder="friend1@example.com,friend2@example.com" />
</div>
<div class="">
	<label class="form-label" for="invite-modal-groups">{{tx("users:groups-to-join")}}</label>
