...
<li>
	<a class="dropdown-item rounded-1 d-flex align-items-center gap-2" component="post/edit" role="menuitem" href="#">
		<span class="menu-icon"><i class="fa fa-fw text-secondary fa-pencil"></i></span> {{tx("topic:edit")}}
	</a>
</li>
...
<li {{{ if posts.deleted }}}hidden{{{ end }}}>
	<a class="dropdown-item rounded-1 d-flex align-items-center gap-2" component="post/delete" role="menuitem" href="#" class="{{{ if posts.deleted }}}hidden{{{ end }}}">
		<span class="menu-icon"><i class="fa fa-fw text-secondary fa-trash-o"></i></span> {{tx("topic:delete")}}
	</a>
</li>
<li {{{ if !posts.deleted }}}hidden{{{ end }}}>
	<a class="dropdown-item rounded-1 d-flex align-items-center gap-2" component="post/restore" role="menuitem" href="#" class="{{{ if !posts.deleted }}}hidden{{{ end }}}">
		<span class="menu-icon"><i class="fa fa-fw text-secondary fa-history"></i></span> {{tx("topic:restore")}}
	</a>
</li>
{{{ end }}}
...
<li {{{ if !posts.deleted }}}hidden{{{ end }}}>
	<a class="dropdown-item rounded-1 d-flex align-items-center gap-2" component="post/purge" role="menuitem" href="#" class="{{{ if !posts.deleted }}}hidden{{{ end }}}">
		<span class="menu-icon"><i class="fa fa-fw text-secondary fa-eraser"></i></span> {{tx("topic:purge")}}
	</a>
</li>
{{{ end }}}
...
<li>
	<a class="dropdown-item rounded-1 d-flex align-items-center gap-2" component="post/move" role="menuitem" href="#">
		<span class="menu-icon"><i class="fa fa-fw text-secondary fa-arrows"></i></span> {{tx("topic:move")}}
	</a>
</li>
{{{ end }}}
...
<li>
	<a class="dropdown-item rounded-1 d-flex align-items-center gap-2" component="post/change-owner" role="menuitem" href="#">
		<span class="menu-icon"><i class="fa fa-fw text-secondary fa-user"></i></span> {{tx("topic:change-owner")}}
	</a>
</li>
{{{ end }}}
...
<li>
	<a class="dropdown-item rounded-1 d-flex align-items-center gap-2" component="post/manage-editors" role="menuitem" href="#">
		<span class="menu-icon"><i class="fa fa-fw text-secondary fa-user-pen"></i></span> {{tx("topic:manage-editors")}}
	</a>
</li>
{{{ end }}}
...
<li>
	<a class="dropdown-item rounded-1 d-flex align-items-center gap-2" component="post/copy-ip" role="menuitem" href="#" data-clipboard-text="{posts.ip}">
		<span class="menu-icon" ><i class="fa fa-fw text-secondary fa-copy"></i></span> {{tx("topic:copy-ip")}} {posts.ip}
	</a>
</li>
...
<li>
	<a class="dropdown-item rounded-1 d-flex align-items-center gap-2" component="post/ban-ip" role="menuitem" href="#" data-ip="{posts.ip}">
		<span class="menu-icon"><i class="fa fa-fw text-secondary fa-ban"></i></span> {{tx("topic:ban-ip")}} {posts.ip}
	</a>
</li>
{{{ end }}}
{{{ end }}}
...
{{{ if !posts.deleted }}}
	...
	<li>
		<a class="dropdown-item rounded-1 d-flex align-items-center gap-2" component="post/view-history" role="menuitem" href="#">
			<span class="menu-icon"><i class="fa fa-fw text-secondary fa-history"></i></span> {{tx("topic:view-history")}}
		</a>
	</li>
	{{{ end }}}
	...
	<li>
		<a class="dropdown-item rounded-1 d-flex align-items-center gap-2" role="menuitem" href="#" data-clipboard-text="{posts.absolute_url}">
			<i class="fa fa-fw text-secondary fa-link"></i> {{tx("topic:copy-permalink")}}
		</a>
	</li>
	{{{ else }}}
	<li>
	...
	<li>
		<a class="dropdown-item rounded-1 d-flex align-items-center gap-2" role="menuitem" target="_self" href="{{{ if posts.url }}}{posts.url}{{{ else }}}{posts.pid}{{{ end }}}">
			<i class="fa fa-fw text-secondary fa-external-link"></i> {{tx("topic:go-to-original")}}
		</a>
	</li>
	{{{ end }}}
...
<li {{{ if posts.flags.flagged }}}hidden{{{ end }}}>
	<a class="dropdown-item rounded-1 d-flex align-items-center gap-2" component="post/flag" role="menuitem" href="#"><i class="fa fa-fw text-secondary fa-flag"></i> {{tx("topic:flag-post")}}</a>
</li>
<li {{{ if !posts.flags.flagged }}}hidden{{{ end }}} class="disabled text-secondary">
	<a class="dropdown-item rounded-1 d-flex align-items-center gap-2" component="post/already-flagged" role="menuitem" href="#" data-flag-id="{posts.flagId}"><i class="fa fa-fw text-secondary fa-flag"></i> {{tx("topic:already-flagged")}}</a>
</li>

{{{ if (!posts.selfPost && posts.uid) }}}
<li>
	<a class="dropdown-item rounded-1 d-flex align-items-center gap-2" component="post/flagUser" role="menuitem" href="#"><i class="fa fa-fw text-secondary fa-flag"></i> {{tx("topic:flag-user")}}</a>
</li>
{{{ end }}}
{{{ end }}}
...
<li>
	<a class="dropdown-item rounded-1 d-flex align-items-center gap-2" role="menuitem" href="{config.relative_path}/flags/{posts.flags.flagId}"><i class="fa fa-fw text-secondary fa-exclamation-circle"></i> {{tx("topic:view-flag-report")}}</a>
</li>
{{{ if (posts.flags.state == "open") }}}
<li>
	<a class="dropdown-item rounded-1 d-flex align-items-center gap-2" component="post/flagResolve" data-flagId="{posts.flags.flagId}" role="menuitem" href="#"><i class="fa fa-fw text-secondary fa-check"></i> {{tx("topic:resolve-flag")}}</a>
</li>
{{{ end }}}
{{{ end }}}
{{{ end }}}
