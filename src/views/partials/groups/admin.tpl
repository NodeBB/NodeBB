	...
	<form component="groups/settings" role="form">
		<div class="row">
			<div class="col-12 col-lg-6">
				...
				<div class="mb-3">
					<label class="form-label" for="description">{{tx("groups:details.description")}}</label>
				...
				<div class="form-check mb-3">
					<label class="form-check-label" for="private">{{tx("groups:details.private")}}</label>
				...
				<div class="form-check mb-3">
					<label class="form-check-label" for="hidden">{{tx("groups:details.hidden")}}</label>
				...
				<div class="form-check mb-3">
					<label class="form-check-label" for="disableJoinRequests">{{tx("groups:details.disableJoinRequests")}}</label>
			...
			<div class="col-12 col-lg-6">
				<div class="d-flex gap-2 align-items-center mb-3">
					<div class="form-check">
						<label class="form-check-label" for="userTitleEnabled">{{tx("groups:details.userTitleEnabled")}}</label>
				...
				<div class="mb-3">
					<label class="form-label" for="userTitle">{{tx("groups:details.badge-text")}}</label>
					<div class="d-flex gap-1">
				...
				<div class="mb-3 d-flex align-items-center justify-content-between gap-5">
					<label class="form-label mb-0 text-nowrap" for="labelColor" class="badge-color-label">{{tx("groups:details.change-label-colour")}}</label>
				...
				<div class="d-flex align-items-center justify-content-between gap-5">
					<label class="form-label mb-0 text-nowrap" for="textColor" class="badge-color-label">{{tx("groups:details.change-text-colour")}}</label>
