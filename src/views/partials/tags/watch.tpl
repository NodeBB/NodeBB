...
<div class="dropdown bottom-sheet" component="tag/watch">
	<button class="btn btn-ghost btn-sm ff-secondary d-flex gap-2 align-items-center dropdown-toggle h-100" data-bs-toggle="dropdown" type="button" aria-haspopup="true" aria-expanded="false">
		<span component="tag/following/menu" class="d-flex gap-2 align-items-center{{{ if !isFollowing }}} hidden{{{ end }}}">
			...
			<span class="d-none d-md-inline fw-semibold">{{tx("tags:watching")}}</span>
		</span>
		...
		<span component="tag/not-following/menu" class="d-flex gap-2 align-items-center{{{ if isFollowing}}} hidden{{{ end }}}">
			...
			<span class="d-none d-md-inline fw-semibold">{{tx("tags:not-watching")}}</span>
		</span>
	</button>
			...
			<a class="dropdown-item rounded-1 d-flex align-items-center gap-2 p-2" href="#" component="tag/following" role="menuitem">
				<div class="flex-grow-1 d-flex flex-column">
					<span class="d-flex align-items-center gap-2">
						...
						<span class="flex-grow-1 fw-semibold">{{tx("tags:watching")}}</span>
					</span>
					<div class="help-text text-muted text-xs">{{tx("tags:watching.description")}}</div>
				</div>
			...
			<a class="dropdown-item rounded-1 d-flex align-items-center gap-2 p-2" href="#" component="tag/not-following" role="menuitem">
				<div class="flex-grow-1 d-flex flex-column">
					<span class="d-flex align-items-center gap-2">
						...
						<span class="flex-grow-1 fw-semibold">{{tx("tags:not-watching")}}</span>
					</span>
					<div class="help-text text-muted text-xs">{{tx("tags:not-watching.description")}}</div>
				</div>
