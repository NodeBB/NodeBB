<button class="btn btn-ghost btn-sm ff-secondary d-flex gap-2 align-items-center dropdown-toggle h-100" data-bs-toggle="dropdown" type="button" aria-haspopup="true" aria-expanded="false">
	...
	<span class="visible-md-inline visible-lg-inline fw-semibold">{{tx("topic:thread-tools.title")}}</span>
...
<ul class="dropdown-menu p-1 text-sm" role="menu">
	...
	<li>
		<a component="topic/move" href="#" class="dropdown-item rounded-1 d-flex align-items-center gap-2" role="menuitem">
			<i class="fa fa-fw fa-arrows text-secondary"></i> {{tx("topic:thread-tools.move")}}
		</a>
	</li>
	{{{if template.category}}}
	<li>
		<a component="topic/move-all" href="#" class="dropdown-item rounded-1 d-flex align-items-center gap-2" role="menuitem">
			<i class="fa fa-fw fa-arrows text-secondary"></i> {{tx("topic:thread-tools.move-all")}}
		</a>
	</li>
	{{{end}}}
	<li>
	...
	<li>
		<a component="topic/tag" href="#" class="dropdown-item rounded-1 d-flex align-items-center gap-2" role="menuitem">
			<i class="fa fa-fw fa-tag text-secondary"></i> {{tx("topic:thread-tools.tag")}}
		</a>
	</li>
	...
	<li>
		<a component="topic/delete" href="#" class="dropdown-item rounded-1 d-flex align-items-center gap-2" role="menuitem">
			<i class="fa fa-fw fa-trash-o text-secondary"></i> {{tx("topic:thread-tools.delete")}}
		</a>
	</li>
	<li>
		<a component="topic/restore" href="#" class="hidden dropdown-item rounded-1" role="menuitem">
			<i class="fa fa-fw fa-history text-secondary"></i> {{tx("topic:thread-tools.restore")}}
		</a>
	</li>
	<li>
		<a component="topic/purge" href="#" class="hidden dropdown-item rounded-1" role="menuitem">
			<i class="fa fa-fw fa-eraser text-secondary"></i> {{tx("topic:thread-tools.purge")}}
		</a>
	</li>
	...
	<li>
		<a href="#" class="dropdown-item rounded-1 d-flex align-items-center gap-2 {./class}" role="menuitem">
			<i class="fa fa-fw {./icon} text-secondary"></i> {{tx("{./title}")}}
		</a>
	</li>
	{{{ end }}}
</ul>