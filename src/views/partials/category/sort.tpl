<div class="dropdown bottom-sheet" component="thread/sort">
	<button class="btn btn-ghost btn-sm ff-secondary d-flex gap-2 align-items-center dropdown-toggle h-100" data-bs-toggle="dropdown" type="button" aria-haspopup="true" aria-expanded="false" aria-label="{{tx("aria:topic-sort-option", sortOptionLabel)}}">
	...
	<ul class="dropdown-menu p-1 text-sm" role="menu">
		...
		<li>
			<a class="dropdown-item rounded-1 d-flex align-items-center gap-2" href="#" data-sort="most_views" role="menuitem">
				<span class="flex-grow-1">{{tx("topic:most-views")}}</span>
				<i class="flex-shrink-0 fa fa-fw text-secondary"></i>
			</a>
		</li>
	</ul>
