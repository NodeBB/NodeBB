<form role="form">
    <div class="mb-3">
        <label class="form-label" for="uid">{{tx("admin/settings/api:uid")}}</label>
        <input id="uid" type="number" inputmode="numeric" pattern="\d+" name="uid" class="form-control" placeholder="0" value="{./uid}" />
        <p class="form-text">
            {{tx("admin/settings/api:uid-help-text")}}
        </p>
    </div>
    <div class="mb-3">
        <label class="form-label" for="description">{{tx("admin/settings/api:description")}}</label>
