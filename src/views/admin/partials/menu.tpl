		...
		<ul id="main-menu">
			...
			<li class="dropdown menu-item">
				...
				<div class="dropdown-menu" role="menu">
					<a class="dropdown-item" href="{relative_path}/admin/general/homepage">Home Page</a>
					<a class="dropdown-item" href="{relative_path}/admin/general/navigation">Navigation</a>
					<a class="dropdown-item" href="{relative_path}/admin/general/languages">Languages</a>
					<a class="dropdown-item" href="{relative_path}/admin/general/sounds">Sounds</a>
					<a class="dropdown-item" href="{relative_path}/admin/general/social">Social</a>
				</div>
			</li>
			<li class="dropdown menu-item">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Manage</a>
				<div class="dropdown-menu" role="menu">
					<a class="dropdown-item" href="{relative_path}/admin/manage/categories">Categories</a>
					<a class="dropdown-item" href="{relative_path}/admin/manage/tags">Tags</a>
					<a class="dropdown-item" href="{relative_path}/admin/manage/users/latest">Users</a>
					<a class="dropdown-item" href="{relative_path}/admin/manage/registration">Registration Queue</a>
					<a class="dropdown-item" href="{relative_path}/admin/manage/groups">Groups</a>
					<a class="dropdown-item" href="{relative_path}/admin/manage/flags">Flags</a>
					<a class="dropdown-item" href="{relative_path}/admin/manage/ip-blacklist">IP Blacklist</a>
				</div>
			</li>
			<li class="dropdown menu-item">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Settings</a>
				<div class="dropdown-menu" role="menu">
					<a class="dropdown-item" href="{relative_path}/admin/settings/general">General</a>
					<a class="dropdown-item" href="{relative_path}/admin/settings/reputation">Reputation</a>
					<a class="dropdown-item" href="{relative_path}/admin/settings/email">Email</a>
					<a class="dropdown-item" href="{relative_path}/admin/settings/user">User</a>
					<a class="dropdown-item" href="{relative_path}/admin/settings/group">Group</a>
					<a class="dropdown-item" href="{relative_path}/admin/settings/guest">Guests</a>
					<a class="dropdown-item" href="{relative_path}/admin/settings/uploads">Uploads</a>
					<a class="dropdown-item" href="{relative_path}/admin/settings/post">Post</a>
					<a class="dropdown-item" href="{relative_path}/admin/settings/chat">Chat</a>
					<a class="dropdown-item" href="{relative_path}/admin/settings/pagination">Pagination</a>
					<a class="dropdown-item" href="{relative_path}/admin/settings/tags">Tags</a>
					<a class="dropdown-item" href="{relative_path}/admin/settings/notifications">Notifications</a>
					<a class="dropdown-item" href="{relative_path}/admin/settings/web-crawler">Web Crawler</a>
					<a class="dropdown-item" href="{relative_path}/admin/settings/sockets">Sockets</a>
					<a class="dropdown-item" href="{relative_path}/admin/settings/advanced">Advanced</a>
				</div>
			</li>
			<li class="dropdown menu-item">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Appearance</a>
				<div class="dropdown-menu" role="menu">
					<a class="dropdown-item" href="{relative_path}/admin/appearance/themes">Themes</a>
					<a class="dropdown-item" href="{relative_path}/admin/appearance/skins">Skins</a>
					<a class="dropdown-item" href="{relative_path}/admin/appearance/customise">Custom HTML &amp; CSS</a>
				</div>
			</li>
			<li class="dropdown menu-item">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Extend</a>
				<div class="dropdown-menu" role="menu">
					<a class="dropdown-item" href="{relative_path}/admin/extend/plugins">Plugins</a>
					<a class="dropdown-item" href="{relative_path}/admin/extend/widgets">Widgets</a>
					<a class="dropdown-item" href="{relative_path}/admin/extend/rewards">Rewards</a>
				</div>
			</li>
			<!-- IF authentication.length -->
			<li class="dropdown menu-item">
			...
			<li class="dropdown menu-item">
				...
				<div class="dropdown-menu" role="menu">
					...
					<!-- END plugins -->
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" data-link="1" href="{relative_path}/admin/extend/plugins">Install Plugins</a>
				</div>
			</li>
			<!-- ENDIF plugins.length -->
			<li class="dropdown menu-item">
				...
				<div class="dropdown-menu" role="menu">
					<a class="dropdown-item" href="{relative_path}/admin/advanced/database">Database</a>
					<a class="dropdown-item" href="{relative_path}/admin/advanced/events">Events</a>
					<a class="dropdown-item" href="{relative_path}/admin/advanced/logs">Logs</a>
					<a class="dropdown-item" href="{relative_path}/admin/advanced/errors">Errors</a>
					<a class="dropdown-item" href="{relative_path}/admin/advanced/post-cache">Post Cache</a>
					<!-- IF env -->
					<a class="dropdown-item" href="{relative_path}/admin/development/logger">Logger</a>
					<!-- ENDIF env -->
				</div>
			</li>
		</ul>
