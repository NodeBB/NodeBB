<div class="manage-users d-flex flex-column gap-2 px-lg-4 h-100">
	<div class="d-flex border-bottom py-2 m-0 sticky-top acp-page-main-header align-items-center justify-content-between flex-wrap gap-2">
		<div class="">
			<h4 class="fw-bold tracking-tight mb-0">{{tx("admin/manage/custom-reasons:title")}}</h4>
		</div>
		<div class="d-flex align-items-center gap-1">
			<button id="new" class="btn btn-light btn-sm text-nowrap" type="button">
				<i class="fa fa-fw fa-plus"></i> {{tx("admin/manage/custom-reasons:create-reason")}}
			</button>
	...
	<p class="text-secondary">{{tx("admin/manage/custom-reasons:reasons-help")}}</p>
			...
			<div class="table-responsive flex-grow-1">
				<table class="table text-sm">
					<thead>
						<tr>
							<th></th>
							<th class="text-muted">{{tx("admin/manage/custom-reasons:reason-title")}}</th>
							<th class="text-muted">{{tx("admin/manage/custom-reasons:reason-type")}}</th>
							<th class="text-muted">{{tx("admin/manage/custom-reasons:reason-body")}}</th>
							<th></th>
						</tr>
					</thead>
					<tbody>
