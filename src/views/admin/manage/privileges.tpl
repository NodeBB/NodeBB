<div class="d-flex flex-column gap-2 px-lg-4">
	...
	<div class="d-flex border-bottom py-2 m-0 sticky-top acp-page-main-header align-items-center justify-content-between flex-wrap gap-2">
		<div class="">
			<h4 class="fw-bold tracking-tight mb-0">{{tx("admin/manage/privileges:manage-privileges")}}</h4>
		</div>
		<div class="d-flex gap-1">
			<button id="discard" class="btn btn-light btn-sm text-nowrap" type="button">
				<i class="fa fa-rotate-left text-danger"></i> {{tx("admin/manage/privileges:discard-changes")}}
			</button>
			...
			<form role="form" class="category">
				<div class="">
					<div class="lead mb-3 d-flex gap-2 align-items-center">
						{{tx("admin/manage/categories:privileges.category-selector")}}

						<!-- IMPORT admin/partials/category/selector-dropdown-left.tpl -->
					</div>
					<p class="text-sm text-secondary">
						{{tx("admin/manage/categories:privileges.description")}}
					</p>
