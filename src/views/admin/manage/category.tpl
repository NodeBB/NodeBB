<div class="category acp-page-container" data-cid="{category.cid}">
	<div component="settings/main/header" class="row border-bottom py-2 m-0 sticky-top acp-page-main-header align-items-center">
		<div class="col-12 col-md-8 px-0 mb-1 mb-md-0 d-flex justify-content-between align-items-center">
			<h4 class="fw-bold tracking-tight mb-0 text-nowrap">{{tx("admin/manage/categories:edit-category")}}</h4>
			...
			<div class="category-settings-form">
				<div class="mb-3">
					<label class="form-label" for="cid-{category.cid}-name">
						{{tx("admin/manage/categories:name")}}
					</label>
				...
				<div class="mb-3">
					<label class="form-label" for="cid-{category.cid}-topic-template">
						{{tx("admin/manage/categories:topic-template")}}
					</label>
					...
					<p class="form-text">
						{{tx("admin/manage/categories:topic-template.help")}}
					</p>
				</div>

				<div class="mb-3 d-flex justify-content-between align-items-center gap-2">
					<label class="form-label" for="cid-{category.cid}-parentCid">{{tx("admin/manage/categories:parent-category")}}</label>
				...
				<div class="mb-3 d-flex justify-content-between align-items-center gap-2">
					<label class="form-label" for="cid-{category.cid}-numRecentReplies">
						{{tx("admin/manage/categories:num-recent-replies")}}
					</label>
				...
				<div class="mb-3 d-flex justify-content-between align-items-center gap-2">
					<label class="form-label" for="cid-subcategories-per-page">
						{{tx("admin/manage/categories:subcategories-per-page")}}
					</label>
				...
				<div class="mb-3 d-flex justify-content-between align-items-center gap-2">
					<label class="form-label" for="cid-subcategories-per-page">
						{{tx("admin/settings/tags:tags-per-topic")}}
					</label>
					<div class="d-flex gap-3 align-items-center">
						<div class="d-flex gap-1 align-items-center">
							<label for="cid-min-tags">{{tx("admin/admin:min")}}</label>
							<input id="cid-min-tags" type="text" class="form-control" data-name="minTags" value="{category.minTags}" style="max-width: 64px;"/>
						</div>
						<div class="d-flex gap-1 align-items-center">
							<label for="cid-max-tags">{{tx("admin/admin:max")}}</label>
				...
				<div class="mb-3">
					<label class="form-label" for="tag-whitelist">{{tx("admin/manage/categories:tag-whitelist")}}</label>
				...
				<div class="mb-3 d-flex flex-column">
					<label class="form-label" for="cid-{category.cid}-link">
						{{tx("admin/manage/categories:ext-link")}}
					</label>
				...
				<div class="mb-3">
					<div class="form-check form-switch">
						...
						<label for="cid-isSection" class="form-check-label">{{tx("admin/manage/categories:is-section")}}</label>
					</div>
				</div>
				...
				<div class="mb-3">
					<div class="form-check form-switch">
						...
						<label for="postQueue" class="form-check-label">{{tx("admin/manage/categories:post-queue")}}</label>
					</div>
				</div>
				{{{ end }}}
				<hr/>
				...
				<div class="mb-3 d-flex flex-column">
					<label class="form-label" for="category-image">
						{{tx("admin/manage/categories:image-and-icon")}}
					</label>
					<div class="d-flex gap-2 align-items-center">
						...
						data-bs-toggle="tooltip" title="{{tx("admin/admin:select-icon")}}"
						style="
						...
						<input id="category-image" type="text" class="form-control flex-1" placeholder="{{tx("admin/manage/categories:category-image")}}" data-name="backgroundImage" value="{category.backgroundImage}" />
						<button type="button" data-cid="{category.cid}" class="btn btn-light upload-button">{{tx("admin/manage/categories:upload")}}</button>
				...
				<div class="mb-3 d-flex justify-content-between align-items-center gap-2">
					<label class="form-label align-self-center" for="cid-{category.cid}-bgColor">
						{{tx("admin/manage/categories:bg-color")}}
					</label>
				...
				<div class="mb-3 d-flex justify-content-between align-items-center gap-2">
					<label class="form-label align-self-center" for="cid-{category.cid}-color">
						{{tx("admin/manage/categories:text-color")}}
					</label>
					<!-- added this to match the height of other blocks -->
					<input type="text" class="form-control invisible" style="width: 0px;">
				...
				<div class="mb-3 d-flex justify-content-between align-items-center gap-2">
					<label class="form-label" for="cid-{category.cid}-imageClass">
						{{tx("admin/manage/categories:bg-image-size")}}
					</label>
				...
				<div class="mb-3 d-flex flex-column justify-content-between">
					<label class="form-label" for="cid-{category.cid}-class">
						{{tx("admin/manage/categories:custom-class")}}
					</label>
