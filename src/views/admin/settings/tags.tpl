	...
	<div class="row settings m-0">
		<div id="spy-container" class="col-12 col-md-8 px-0 mb-4" tabindex="0">
			<div id="tag-settings" class="mb-4">
				<h5 class="fw-bold tracking-tight settings-header">{{tx("admin/settings/tags:tag")}}</h5>
				<div class="mb-3">
					<label class="form-label" for="systemTags">{{tx("admin/settings/tags:system-tags")}}</label>
					<input id="systemTags" type="text" class="form-control" value="" data-field="systemTags" data-field-type="tagsinput" />
					<p class="form-text">
						{{tx("admin/settings/tags:system-tags-help")}}
					</p>
				</div>
				<div class="mb-3">
					<label class="form-label" for="minimumTagsPerTopics">{{tx("admin/settings/tags:min-per-topic")}}</label>
					<input id="minimumTagsPerTopics" type="text" class="form-control" value="0" data-field="minimumTagsPerTopic">
				</div>
				<div class="mb-3">
					<label class="form-label" for="maximumTagsPerTopics">{{tx("admin/settings/tags:max-per-topic")}}</label>
					<input id="maximumTagsPerTopics" type="text" class="form-control" value="5" data-field="maximumTagsPerTopic">
				</div>
				<div class="mb-3">
					<label class="form-label" for="minimumTagLength">{{tx("admin/settings/tags:min-length")}}</label>
			...
			<div id="related-topics" class="mb-4">
				<h5 class="fw-bold tracking-tight settings-header">{{tx("admin/settings/tags:related-topics")}}</h5>
				<div class="mb-3">
					<label class="form-label" for="maximumRelatedTopics">{{tx("admin/settings/tags:max-related-topics")}}</label>
