		...
		<form>
			...
			<div class="checkbox">
				<label class="mdl-switch mdl-js-switch mdl-js-ripple-effect">
					...
					<span class="mdl-switch__label"><strong>[[admin/settings/reputation:disable-down-voting]]</strong></strong>
				</label>
			</div>
			<div class="checkbox">
				<label class="mdl-switch mdl-js-switch mdl-js-ripple-effect">
					<input type="checkbox" class="mdl-switch__input" data-field="votesArePublic">
					<span class="mdl-switch__label"><strong>[[admin/settings/reputation:votes-are-public]]</strong></strong>
				</label>
			</div>
		</form>
	</div>
