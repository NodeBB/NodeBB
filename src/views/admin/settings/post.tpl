...
<div class="row">
	<div class="col-sm-2 col-xs-12 settings-header">[[admin/settings/post:linkback]]</div>
	<div class="col-sm-10 col-xs-12">
		<form>
			<div class="checkbox">
				<label class="mdl-switch mdl-js-switch mdl-js-ripple-effect">
					<input class="mdl-switch__input" type="checkbox" data-field="topicLinkback">
					<span class="mdl-switch__label"><strong>[[admin/settings/post:linkback.enabled]]</strong></span>
					<p class="help-block">[[admin/settings/post:linkback.help]]</p>
				</label>
			</div>
		</form>
	</div>
