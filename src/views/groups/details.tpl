			...
			<div class="tab-content">
				...
				<div class="tab-pane fade" id="groups-invited" role="tabpanel">
					<div class="d-flex align-items-center justify-content-between mb-3">
						<h3 class="fw-semibold fs-5">[[groups:details.invited]]</h3>
						<button component="groups/invite-members" class="btn btn-primary btn-sm" type="button">[[groups:invite-members]]</button>
					</div>
