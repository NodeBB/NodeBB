...
Categories.getAllCidsFromSet = async function (key: string) {
...
Categories.getAllCategories = async function (uid: string) {
...
export default Categories as any;