...
Plugins.pluginsData  = {} as any;
Plugins.libraries  = {} as any;
Plugins.loadedHooks  = {} as any;
Plugins.staticDirs  = {} as any;
Plugins.cssFiles  = [];
Plugins.scssFiles  = [];
...
Plugins.showInstalled = async function () {
	...
	let pluginPaths = await findNodeBBModules(dirs) as any;
