...
function getSoundpack(pluginData, callback) {
	...
	async.each(Object.keys(spack.sounds), function (name, next) {
		...
		file.exists(path.join(soundpack.dir, soundFile), function (exists) {
			if (!exists) {
...
module.exports = function (Plugins) {
	Plugins.getPluginPaths = getPluginPaths;
	Plugins.loadPluginInfo = loadPluginInfo;

	Plugins.data = {};
	Plugins.data.getAll = getAllPluginData;
	Plugins.data.getSoundpack = getSoundpack;
	Plugins.data.getStaticDirectories = getStaticDirectories;
	Plugins.data.getFiles = getFiles;
	Plugins.data.getScripts = getScripts;
	Plugins.data.getModules = getModules;
	Plugins.data.getSoundpack = getSoundpack;
};
