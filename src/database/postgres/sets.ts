...
DO NOTHING`,
	...
	module.setsAdd = async function (keys: string[], value) {
...
DO NOTHING`,
	...
	module.setRemove = async function (key: string | string[], value) {
...
SELECT s."member" m
 ...
 WHERE o."_key" = $1::TEXT
   AND s."member" = ANY($2::TEXT[])`,
	...
	module.isMemberOfSets = async function (sets: string[], value) {
