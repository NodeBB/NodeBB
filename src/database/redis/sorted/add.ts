...
export default  function (module) {
	...
	module.sortedSetAdd = async function (key: string, score: number , value) {
		if (!key) {
			return;
		}
	...
	async function sortedSetAddMulti(key: string, scores: string[], values: string[]) {
	...
	module.sortedSetsAdd = async function (keys: string[], scores: string[], value) {
