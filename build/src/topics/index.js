...
Topics.exists = function (tids) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield database_1.default.exists(Array.isArray(tids) ? tids.map(tid => `topic:${tid}`) : `topic:${tids}`);
    });
};
Topics.getTopicsFromSet = function (set, uid, start, stop) {
    return __awaiter(this, void 0, void 0, function* () {
        const tids = yield database_1.default.getSortedSetRevRange(set, start, stop);
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                function loadShowfullnameSettings() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        const data = yield database_1.default.getObjectsFields(uids.map((uid) => `user:${uid}:settings`), ['showfullname']);
