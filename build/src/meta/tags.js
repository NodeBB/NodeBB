...
Tags.parse = (req, data, meta, link) => __awaiter(void 0, void 0, void 0, function* () {
    // Meta tags
    const defaultTags = [{
            name: 'viewport',
    ...
    meta = results.tags.tags.concat(meta || []).map((tag) => {
        if (!tag || typeof tag.content !== 'string') {
            winston_1.default.warn('Invalid meta tag. ', tag);
            return tag;
        }
        if (!tag.noEscape) {
...
function addSiteOGImage(meta) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { images } = yield plugins.hooks.fire('filter:meta.addSiteOGImage', {
            images: [{
