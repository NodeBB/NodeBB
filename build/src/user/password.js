...
function default_1(User) {
    ...
    User.isPasswordCorrect = function (uid, password, ip) {
        return __awaiter(this, void 0, void 0, function* () {
            password = password || '';
            let { password: hashedPassword, 'password:shaWrapped': shaWrapped, } = yield db.getObjectFields(`user:${uid}`, ['password', 'password:shaWrapped']);
            if (!hashedPassword) {
    ...
    User.hasPassword = function (uid) {
        return __awaiter(this, void 0, void 0, function* () {
            const hashedPassword = yield db.getObjectField(`user:${uid}`, 'password');
