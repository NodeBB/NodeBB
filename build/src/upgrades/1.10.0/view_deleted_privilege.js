    ...
    method: function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const cid of cids) {
                const uids = yield database_1.default.getSortedSetRange(`group:cid:${cid}:privileges:moderate:members`, 0, -1);
                for (const uid of uids) {
                    yield groups.join(`cid:${cid}:privileges:posts:view_deleted`, uid);
                }
                progress.incr();
            }
        });
