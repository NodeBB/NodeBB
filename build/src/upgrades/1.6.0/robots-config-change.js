        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (config) {
                ...
                if (config.robots && config.robots.txt) {
                    yield database_1.default.setObjectField('config', 'robots:txt', config.robots.txt);
                }
                else if (typeof config['robots.txt'] === 'string' && config['robots.txt']) {
                    yield database_1.default.setObjectField('config', 'robots:txt', config['robots.txt']);
                }
                yield database_1.default.deleteObjectField('config', 'robots');
                yield database_1.default.deleteObjectField('config', 'robots.txt');
            }
        });
    },
};
