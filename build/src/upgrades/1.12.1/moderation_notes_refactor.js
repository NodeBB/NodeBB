        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield batch.processSortedSet('users:joindate', (uids) => __awaiter(this, void 0, void 0, function* () {
                yield Promise.all(uids.map((uid) => __awaiter(this, void 0, void 0, function* () {
                    progress.incr();
                    const notes = yield db.getSortedSetRevRange(`uid:${uid}:moderation:notes`, 0, -1);
                    for (const note of notes) {
                        const noteData = JSON.parse(note);
                        noteData.timestamp = noteData.timestamp || Date.now();
                        yield db.sortedSetRemove(`uid:${uid}:moderation:notes`, note);
                        yield db.setObject(`uid:${uid}:moderation:note:${noteData.timestamp}`, {
                            uid: noteData.uid,
