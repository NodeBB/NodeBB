...
usersController.getUsersAndCount = function (set, uid, start, stop) {
    return __awaiter(this, void 0, void 0, function* () {
        function getCount() {
            return __awaiter(this, void 0, void 0, function* () {
                if (set === 'users:online') {
                    return yield db.sortedSetCount('users:online', Date.now() - 86400000, '+inf');
                }
                else if (set === 'users:banned' || set === 'users:flags') {
                    return yield db.sortedSetCard(set);
                }
                return yield db.getObjectField('global', 'userCount');
            });
        }
        function getUsers() {
            return __awaiter(this, void 0, void 0, function* () {
                if (set === 'users:online') {
                    ...
                    const data = yield db.getSortedSetRevRangeByScoreWithScores(set, start, count, '+inf', Date.now() - 86400000);
